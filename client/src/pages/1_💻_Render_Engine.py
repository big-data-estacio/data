...
st.title('💻 Motor de Renderização')

st.write("Mecanismo rápido para renderizar código Manim. Cole seu código e clique em gerar. É isso!")
...
code_response = st.text_area(label="Código gerado: ",
                             value=code_example,
                             key="code_input")

generates_code = st.button(
    ":computer: Renderizar vídeo :sparkles:", type="primary")
